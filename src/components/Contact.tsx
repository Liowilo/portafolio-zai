              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:julianflores.ia@gmail.com" className="text-gray-400 hover:text-purple-400 transition-colors">
                      julianflores.ia@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+528110508180" className="text-gray-400 hover:text-purple-400 transition-colors">
                      +81 1050 8180
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Abierto a oportunidades</p>
                  </div>
                </div>
              </div>
